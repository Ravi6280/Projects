...
purple = pygame.Color(128, 0, 128)  # Custom color for the snake's head
yellow = pygame.Color(255, 255, 0)  # Custom color for the food

# Load food image
food_image = pygame.image.load('food.png')
food_image = pygame.transform.scale(food_image, (20, 20))  # Scale the image to match the food size

snake_head_image = pygame.image.load('snake-head.png')
